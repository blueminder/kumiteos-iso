...
wget "https://github.com/blueminder/flycast-dojo/releases/download/dojo-0.5.33/linux-flycast-dojo-0.5.33.zip"
unzip linux-flycast-dojo-0.5.33.zip
chmod +x flycast-dojo-x86_64.AppImage
rm linux-flycast-dojo-0.5.33.zip
